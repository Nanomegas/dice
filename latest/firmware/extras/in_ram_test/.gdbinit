# this file configures the dice for running in internal ram tests
# do not use for redboot.elf or DICE application debugging

set endian little

# for OpenOCD probes, such as JTAGkey
