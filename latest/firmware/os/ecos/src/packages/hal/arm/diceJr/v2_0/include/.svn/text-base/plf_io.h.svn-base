...
#define GPCSR_AUDIO_SEL         (GPCSRBASE + 0x004)
#define GPCSR_GPIO_SEL          (GPCSRBASE + 0x008)
#define GPCSR_CHIP_ID           (GPCSRBASE + 0x014)
...
#define PWRMGR_RST_FLAGS        (PWRMGRBASE + 0x10)
