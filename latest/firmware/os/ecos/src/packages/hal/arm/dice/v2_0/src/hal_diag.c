...
cyg_hal_plf_serial_init_channel(void* __ch_data)
{
    ...
    *((volatile int *)(base + UART_DLL)) = 
		CYGNUM_HAL_ARM_DICE_CLOCK_SPEED/
...
/* zluo, should we use the timeout register? */
cyg_bool
...
static channel_data_t dice_ser_channels[2] = {
...
cyg_hal_plf_serial_init(void)
{
    ...
    // Init channels
    cyg_hal_plf_serial_init_channel(&dice_ser_channels[0]);
#if CYGNUM_HAL_VIRTUAL_VECTOR_COMM_CHANNELS > 1
    cyg_hal_plf_serial_init_channel(&dice_ser_channels[1]);
#endif
    ...
    CYGACC_COMM_IF_CH_DATA_SET(*comm, &dice_ser_channels[0]);
    ...
    comm = CYGACC_CALL_IF_CONSOLE_PROCS();
    CYGACC_COMM_IF_CH_DATA_SET(*comm, &dice_ser_channels[1]);
    CYGACC_COMM_IF_WRITE_SET(*comm, cyg_hal_plf_serial_write);
    CYGACC_COMM_IF_READ_SET(*comm, cyg_hal_plf_serial_read);
    CYGACC_COMM_IF_PUTC_SET(*comm, cyg_hal_plf_serial_putc);
    CYGACC_COMM_IF_GETC_SET(*comm, cyg_hal_plf_serial_getc);
